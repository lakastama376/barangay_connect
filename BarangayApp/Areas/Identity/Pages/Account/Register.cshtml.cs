...
namespace BarangayApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [Display(Name = "Barangay Certificate")]
            public IFormFile BarangayCertificate { get; set; }
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.BarangayCertificate != null)
                {
                    ...
                    var fileName = Guid.NewGuid().ToString() + Path.GetExtension(Input.BarangayCertificate.FileName);
                    var filePath = Path.Combine(uploadsFolder, fileName);

                    using (var stream = new FileStream(filePath, FileMode.Create))
                    {
                        await Input.BarangayCertificate.CopyToAsync(stream);
                    }
                ...
                user.MiddleName = string.IsNullOrEmpty(Input.MiddleName) ? null : Input.MiddleName;
                ...
                user.BarangayCertificatePath = certificatePath;
